...
@interface rootViewController ()<UIViewControllerTransitioningDelegate,UINavigationControllerDelegate,UIScrollViewDelegate>
{
    UIImageView *imageV;
    UIImage *image;
...
//    self.navigationController.delegate = self;
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        label.alpha = 1;
        bgScrollView.contentSize = CGSizeMake(self.view.frame.size.width, label.frame.origin.y + label.frame.size.height);
    }];
}
...
//    CGFloat height = image.size.height - scrollView.contentOffset.y/2;
//    CGRect rect = imageV.frame;
//    rect.size = CGSizeMake(image.size.width, height);
//    imageV.frame = rect;
